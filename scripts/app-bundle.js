...
define('slider',['exports', 'flickity'], function (exports, _flickity) {
    'use strict';
...
define('services/PhotoService',['exports', 'aurelia-framework', 'aurelia-fetch-client', 'fetch'], function (exports, _aureliaFramework, _aureliaFetchClient) {
    'use strict';
    ...
    var PhotoService = exports.PhotoService = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient), _dec(_class = function PhotoService(http) {
...
define("Modernizr/lib/cli", [],function(){});
;define('Modernizr', ['Modernizr/lib/cli'], function (main) { return main; });
